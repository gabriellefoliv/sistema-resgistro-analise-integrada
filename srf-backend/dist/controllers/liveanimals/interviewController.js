...
const interviewService_1 = require("../../services/liveanimals/interviewService");
const auditService_1 = require("../../services/auditService");
class InterviewController {
    auditService = new auditService_1.AuditService();
    interviewService = new interviewService_1.InterviewService();
    formId = 'entrevista';
    ...
    create = async (req, res) => {
        try {
            ...
            if (error.message === 'Já existe uma entrevista para este tutor.')
                return res.status(409).json({ error: error.message });
            if (error.message === 'Um ou mais animais não estão associados ao tutor.')
    ...
    update = async (req, res) => {
        try {
            ...
            if (error.message === 'Entrevista não encontrada.')
