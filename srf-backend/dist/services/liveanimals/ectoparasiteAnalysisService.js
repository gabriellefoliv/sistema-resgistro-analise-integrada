...
exports.EctoparasiteAnalysisService = void 0;
const __1 = require("../../");
const auditService_1 = require("../auditService");
class EctoparasiteAnalysisService {
    auditService = new auditService_1.AuditService();
    formId = 'analiseectoparasitos-av';
    async getAll(requesterId) {
        const results = await __1.prisma.ectoparasiteAnalysisVeterinarian.findMany({
            select: {
                id: true,
                veterinarianVisit: {
                    select: {
    ...
    async update(recordId, data, requesterId) {
        return __1.prisma.$transaction(async (tx) => {
            ...
            if (existingResultRepeat)
                throw new Error('Não é possivel atualizar para uma análise de ectoparasitos com informações repetidas (visita veterinária, gênero, espécie e subespécie).');
            // Atualiza
...
exports.EctoparasiteAnalysisService = EctoparasiteAnalysisService;
//# sourceMappingURL=ectoparasiteAnalysisService.js.map