...
CREATE TABLE `rastreio_gps` (
  ...
  `data_atualizacao_planilha_bruta` datetime(3) DEFAULT NULL,
  `data_atualizacao_planilha_editada` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-05-21  8:43:44
